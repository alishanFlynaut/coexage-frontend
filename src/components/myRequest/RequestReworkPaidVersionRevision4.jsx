...
const RequestReworkPaidVersionRevision4 = () => {
  return (
    <>
        ...
        <div className="container-fluid page-body-wrapper pt-70">
          ...
          <div className="main-panel">
            ...
            <div className="content-wrapper">
              <div className="container">
                <div className="mainpage-tabs-area revision-area revision-sidebar">
                        ...
                        <div className="tabs-text text-left revision-full-width">
                          <div className="row">
                            <div className="col-md-12">
                              <div className="revision-left mb-4">
                                <div className="tab-content-area">
                                  <h2>Request a Revision (#4)</h2>
                                  <p>
                                    <span className="org">Note:</span> You are
                                    eligible now eligible for (1/3) revision
                                    requests.
                                  </p>
                                  <p>
                                    Please elaborate in detail on what you’d
                                    like revised in the draft.
                                  </p>
                                  ...
                                  <div className="form-group text-end">
                                    <a
                                      href="#"
                                      className="btn btn-secondary me-2 smile-btn"
                                    >
                                      <img
                                        src="/images/tabler_mood-smile.png"
                                        alt=""
                                      />
                                    </a>
                                    <a
                                      href="#"
                                      className="btn btn-secondary me-2 attachment-btn"
                                    >
                                      <img
                                        src="/images/iconoir_attachment.png"
                                        alt=""
                                      />
                                    </a>
                                    <a
                      ...
                      >
                        <div className="substabs-boxs">
                          <span className="top-texts">
                            Below you will find the detailed information about
                            the project you requested.
                          </span>
                          <nav>
                            <div
                            ...
                            >
                              ...
                              <div className="sub-tab-text">
                                <div className="box-info">
                                  ...
                                  <p>
                                    World in 2050 and Artifical Intelligence
                                  </p>
                                </div>
                                ...
                                <div className="box-info">
                                  ...
                                  <p>
                                    Lorem ipsum dolor sit amet, consectetur
                                    adipiscing elit. Viverra tempor cras et sed
                                    rhoncus, risus.
                                  </p>
                                </div>
                              </div>
                            ...
                            >
                              ...
                              <div className="sub-tab-text">
                                ...
                                <div className="box-info">
                                  ...
                                  <p>
                                    Lorem ipsum dolor sit amet, consectetur
                                    adipiscing elit. Id nulla feugiat lectus
                                    fermentum, tincidunt. Tellus et hendrerit
                                    adipiscing elementum maecenas mauris feugiat
                                    elit. In turpis augue phasellus lectus amet
                                    id donec aliquet massa. Pharetra in tellus
                                    quis quam odio ultrices eget. Rutrum mollis
                                    augue elementum venenatis. Suspendisse
                                    maecenas egestas vitae viverra rhoncus.
                                    Magna amet euismod ut mauris dictumst.
                                    Tellus fermentum lorem odio suspendisse sit
                                    enim in ornare a. Semper tempus nibh cursus
                                    sit ultrices.
                                  </p>
                                </div>
                                ...
                                <div className="box-info">
                                  ...
                                  <a href="#" className="links">
                                    www.facebook.com/company-name
                                  </a>
                                  <br />
                                  <a href="#" className="links">
                                    www.instagram.com/company-name
                                  </a>
                                </div>
                                ...
                                <div className="box-info">
                                  ...
                                  <p>
                                    Lorem ipsum dolor sit amet, consectetur
                                    adipiscing elit. Congue in gravida
                                    condimentum tincidunt a, euismod posuere et
                                    bibendum. Netus lorem lectus donec velit
                                    consectetur ornare lacinia est, convallis.
                                    Pretium augue aliquam arcu scelerisque sit
                                    ut est urna.
                                  </p>
                                </div>
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content text-center">
            <div className="modal-header">
              <h5 className="modal-title">Request Sent</h5>
              <button
                type="button"
                className="btn-close"
            ...
            <div className="modal-body">
              <img src="/images/note-edit-line.png" className="mb-3" alt="" />
              <h2>Your request for new title has been sent to writer</h2>
              <p>
                You will receive a notification about the newtitke. You can also
                check ‘Activity’ tab of this project.{" "}
              </p>
            </div>
          </div>
        </div>
      </div>
      {/* <!-- End RequestSendModal Modal--> */}
...
export default RequestReworkPaidVersionRevision4;
