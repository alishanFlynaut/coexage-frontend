...
const RequestReworkPaidVersion = () => {
  return (
    <>
                          ...
                          <div className="row">
                            <div className="col-md-9">
                              <div className="revision-left mb-4">
                                <h1>Revision #3</h1>
                                <p>
                                  Current draft is ready for your review. If
                                  you're satisfied with it, you can approve and
                                  close. Otherwise you may request a revision.
                                </p>
                                <div className="top-btn-area">
                                  ...
                                  >
                                    <img src="/images/akar-icons_star-w.png" />
                                    Approve
                                  </a>
                                  <a
                                    href="#"
                                    ...
                                    data-bs-toggle="modal"
                                    data-bs-target="#PaidVersionModal"
                                  >
                                ...
                                <div className="tab-content-area">
                                  ...
                                  <p>
                                    ...
                                    adipiscing elit. Nisl, aliquet cras nibh
                                    praesent arcu quam egestas. Sed massa dolor
                                    egestas odio eget condimentum. Consectetur
                                    massa lacus, convallis sed faucibus at eu
                                    odio. Scelerisque in est, eu nisl.
                                    Pellentesque amet, accumsan justo vel elit,
                                    bibendum.{" "}
                                  </p>
                                </div>
                              </div>
                            ...
                            <div className="col-md-3">
                              <div className="right-sidebar revision-sidebar d-flex">
                                <h2 className="revision-widget-title">
                                  Revision History
                                </h2>
                                <ul>
                                  <li className="active">
      ...
      >
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <form className="paid-version-frm">
              <div className="modal-header">
                <h5 className="modal-title">
                  Free Requests For Revisions Has Ended!{" "}
                </h5>
                <button
                  type="button"
                  className="btn-close"
              ...
              <div className="modal-body">
                <p>
                  You can no longer request revisions for free. Please note that
                  you are no longer able to send requests to our editors. If you
                  wish to continue, you can check out our plans.
                </p>

                <div className="frm-content d-flex justify-content-between">
                    ...
                    <div className="form-group">
                      <div className="price-row">
                        ...
                        <label for="optionsRadios1">
                          {" "}
                          6 Revision Requests{" "}
                          <span>One-time payment of $250</span>
                        </label>
                      </div>
                      ...
                      <div className="price-row">
                        ...
                        <label for="optionsRadios2">
                          {" "}
                          3 Revision Requests{" "}
                          <span>One-time payment of $150</span>
                        </label>
                      </div>
                      ...
                      <div className="price-row">
                        ...
                        <label for="optionsRadios3">
                          {" "}
                          1 Revision Requests{" "}
                          <span>One-time payment of $50</span>
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="form-group">
                      <div className="promo-code-wrap">
                        <div className="d-flex align-items-center">
                          <img
                            src="/images/mdi_coupon-outline.png"
                            alt=""
                            className="me-2"
                          />
                          <span>Promo Code Applied</span>
                        </div>
                        <div className="code-wrap d-flex justify-content-between">
                          <div>GET20</div>
                          <a href="#">Cancel</a>
                        </div>
                      </div>
      ...
      {/* <!-- End PaidVersionModal Modal--> */}
    </>
  );
};

export default RequestReworkPaidVersion;
