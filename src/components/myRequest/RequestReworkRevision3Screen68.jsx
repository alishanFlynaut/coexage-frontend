...
const RequestReworkRevision3Screen68 = () => {
  return (
    <>
                          ...
                          <div className="row">
                            <div className="col-md-9">
                              <div className="revision-left mb-4">
                                <h1>
                                  Your draft has been submitted for Revision #3
                                </h1>
                                <p>
                                  It has been noted that you requested this
                                  change. Our editor will begin working on
                                  making the changes soon. Currently, you are
                                  viewing{" "}
...
export default RequestReworkRevision3Screen68;
