                    ...
                    <div className="d-flex page-title">
                      <div className="title">
                        <h1 className="main-title">
                          <span>Request Type:</span> Blog / Article{" "}
                        </h1>
                      </div>
                      ...
                      >
                        <div className="tabs-text">
                          <div className="top-btn-area">
                            <a
                              href="#"
                              className="btn btn-primary me-2 mb-2 tab-download-btn"
                            >
                              <img src="/images/akar-icons_download.png" />
                              Download Content
                            </a>
                            <a
                              href="#"
                              className="btn btn-secondary me-2 mb-2 tab-download-btn"
                              data-bs-toggle="modal"
                              data-bs-target="#RateExperienceModal"
                            >
                              <img src="/images/akar-icons_star.png" />
                              Order From Same Writer
                            </a>
                          </div>
                          ...
                          <div className="tab-content-area">
                            ...
                            <p>
                              ...
                              elit. Nisl, aliquet cras nibh praesent arcu quam
                              egestas. Sed massa dolor egestas odio eget
                              condimentum. Consectetur massa lacus, convallis
                              sed faucibus at eu odio. Scelerisque in est, eu
                              nisl. Pellentesque amet, accumsan justo vel elit,
                              bibendum. Habitasse at cursus duis adipiscing et
                              venenatis, lobortis hendrerit. Id commodo
                              elementum quis pulvinar semper. Sed quisque
                              facilisis eu, quam.
                            </p>
                          </div>
                        </div>
            ...
            <form>
              ...
              <div className="modal-body text-center">
                ...
                <div className="rating-wrap">
                  ...
                  <img src="/images/star-fill.png" alt="" />
                  <img src="/images/star-fill.png" alt="" />
                  <img src="/images/star-outline-empty.png" alt="" />
                </div>
              </div>
...
export default RequestReworkCompleted;
