...
const RequestReworkRevision2Screen62 = () => {
  return (
    <>
              ...
              <div className="mainpage-tabs-area revision-area revision-sidebar">
                          ...
                          <div className="col-md-9">
                            <div className="revision-left mb-4">
                              ...
                              <div className="tab-content-area">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nisl, aliquet cras nibh praesent arcu quam egestas. Sed massa dolor egestas odio eget condimentum. Consectetur massa lacus, convallis sed faucibus at eu odio. Scelerisque in est, eu nisl. Pellentesque amet, accumsan justo vel elit, bibendum. Habitasse at cursus duis adipiscing et venenatis, lobortis hendrerit. Id commodo elementum quis pulvinar semper. Sed quisque facilisis eu, quam.</p>
                              </div>
                            </div>                            
                          </div>
                          <div className="col-md-3">
                            <div className="right-sidebar revision-sidebar d-flex">
                              <h2 className="revision-widget-title">Revision History</h2>
                              <ul>
                                <li className="active">
                                  <div className="d-flex justify-content-between revision-box">
                                    <div className="revi-left">
                                      <h3>R2</h3>
                                    </div>
                                    <div className="revi-mid">
                                      <h4>Revision 1</h4>
                                      <span className="status">No remarks</span>
                      ...
                      <div className="tabs-text text-left bg-white">
                        <div className="contet-box d-flex justify-content-between">
                          <div className="left">
                            ...
                            <h2>Why mobile app development is in high demand?</h2>
                            <p>Congratulations! You have just finalized your blog title. The next step is the writer will start writing the content! 
                            Hang tight... You will receive a notification about the new content You can also check Content tab of this project. </p>
                          </div>
                        ...
                        <div className="contet-box-footer">
                          <div className="d-flex justify-content-between align-items-center">
                            <span className="red-text">Update: Our writer ‘James Warner’ has started working on the content</span>
                            <div className="btn-area">
                              <a href="#" className="btn btn-secondary me-2" data-bs-toggle="modal" data-bs-target="#RequestSendModal">Request New Title</a>
                              <a href="#" className="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#ApproveTitleModal">Accept Title</a>
                            </div>  
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="tabs-text text-left bg-white">
                        <div className="listed-box d-flex justify-content-between">
                          <div className="left">
                            <h3>Lorem Ipsum</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Elementum sed tellus turpis quis mauris ipsum.<br/>
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <p>Once approved the titket, you wont be able to request it for another title.</p>
            </div>
      ...
      <div className="modal fade ApproveContentModal" id="ApproveContentModal" tabIndex="-1">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <h2 className="mb-2">Are you sure you want to approve this content?</h2>
              <p>Once approved the content, you wont be able to request it for another revision.</p>
            </div>
            <div className="modal-footer justify-content-end">
              <button type="button" className="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
              <button type="button" className="btn btn-primary">Approve</button>
...
export default RequestReworkRevision2Screen62