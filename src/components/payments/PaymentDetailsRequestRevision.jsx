...
const PaymentDetailsRequestRevision = () => {
  return (
                      ...
                      <div className="ord-summary-body">
                        ...
                        <div className="ord-summary-item">
                          <div className="ord-summary-info">
                            <span className="label-info">Graphics</span>
                            <h5 className="title-info">2 Images</h5>
                          </div>
                        </div>
                        ...
                        <div className="ord-summary-item">
                          <div className="ord-summary-info">
                            ...
                            <h5 className="title-info">$15.00</h5>
                          </div>
                        </div>

                        <div className="ord-summary-item">
                          <div className="ord-summary-info">
                            <span className="label-info">Content Type</span>
                            <h5 className="title-info">Blog</h5>
                          </div>
                        </div>
                      </div>
                    </div>
...
export default PaymentDetailsRequestRevision;
