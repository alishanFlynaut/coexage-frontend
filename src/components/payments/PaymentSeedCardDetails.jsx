...
const PaymentSeedCardDetails = () => {
  return (
    <div className="container-scroller">
      ...
      {/* <!-- partial --> */}
      <div className="container-fluid page-body-wrapper pt-70 payment-card-details-page payment-success-page">
                      ...
                      <div className="ord-summary-body">
                        ...
                        <div className="ord-summary-item">
                          <div className="ord-summary-info">
                            ...
                            <h5 className="title-info">Seed</h5>
                          </div>
                        </div>
                        ...
                        <div className="ord-summary-item">
                          <div className="ord-summary-info pri-info">
                            ...
                            <h5 className="title-info">$397.00 <span className="subs-limit">/ month</span></h5>
                          </div>
                        </div>
                        ...
                        <div className="ord-summary-item">
                          <div className="ord-summary-info">
                            ...
                            <h5 className="title-info">1500 words per month</h5>
                          </div>
                        </div>

                      </div>
                      <div className="ord-summary-footer">
                        <a href="#">Check other packages <img src="images/title-edit-icon.png" alt="" /></a>
                      </div>
                    </div>
                  </div>
                </div>
                          ...
                          <div className="row">
                            <div className="col-md-12">
                              <div className="form-group">
                                <label className="col-form-label">Enter Card Number</label>
                            ...
                            <div className="col-md-4">
                              <div className="form-group">
                                <label className="col-form-label">Valid Through</label>
                                <div className="single-input">
                            ...
                            <div className="col-md-8">
                              <div className="form-group">
                                ...
                                <div className="single-input cvv-input">
                                  <img src="assets/images/question-fill-icon.png" alt="" />
                                  <input 
                                  type="text" 
                                  className="form-control" 
...
export default PaymentSeedCardDetails;
