...
const PaymentAccelerateCardDetails = () => {
    return (
    <>
            <div className="container-scroller">
                ...
                {/* <!-- partial --> */}
                <div className="container-fluid page-body-wrapper pt-70 payment-accelerate-card-details payment-success-page">
                    ...
                    <div className="main-panel">
                                                                    ...
                                                                    <div className="form-group">
                                                                        ...
                                                                        <div className="single-input">
                                                                            <img src="images/user-circle.png" alt=""/>
                                                                                <input type="text" className="form-control" placeholder="Your Cardholder Name"/>
                                                                                </div>
                                                                        </div>
                                                                    </div>
                        ...
                        export default PaymentAccelerateCardDetails;
