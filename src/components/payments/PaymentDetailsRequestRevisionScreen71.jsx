...
const PaymentDetailsRequestRevisionScreen71 = () => {
  return (
    ...
    {/* <!-- partial --> */}
    <div className="container-fluid page-body-wrapper pt-70 payment-details-page">
                    ...
                    <div className="ord-summary-body">
                      ...
                      <div className="ord-summary-item">
                        <div className="ord-summary-info">
                          ...
                          <h5 className="title-info">6 Revision Requests</h5>
                        </div>
                      </div>
                      ...
                      <div className="ord-summary-item">
                        <div className="ord-summary-info">
                          ...
                          <h5 className="title-info">$250.00</h5>
                        </div>
                      </div>

                      <div className="ord-summary-item">
                        <div className="ord-summary-info">
                          <span className="label-info">Revision Request Limit</span>
                          <h5 className="title-info">6 Requests</h5>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <form>
                        <div className="row">
                          ...
                          <div className="col-md-8">
                            <div className="form-group">
                              <label className="col-form-label">CVV (3 Digits)</label>
...
export default PaymentDetailsRequestRevisionScreen71;
