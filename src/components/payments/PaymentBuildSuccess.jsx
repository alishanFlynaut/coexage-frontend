...
const PaymentBuildSuccess = () => {
  return (
    <div className="container-scroller">
      ...
      {/* <!-- partial --> */}
      <div className="container-fluid page-body-wrapper pt-70 payment-seed-success-page payment-success-page">
...
export default PaymentBuildSuccess;
