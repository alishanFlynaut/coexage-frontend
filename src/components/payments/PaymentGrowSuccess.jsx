...
const PaymentGrowSuccess = () => {
  return (
    <div className="container-scroller">
      ...
      {/* <!-- partial --> */}
      <div className="container-fluid page-body-wrapper pt-70 payment-grow-success payment-success-page">
                      ...
                      <div className="ord-summary-body">
                        ...
                        <div className="ord-summary-item">
                          <div className="ord-summary-info pri-info">
                            ...
                            <h5 className="title-info">$1797.00 <span className="subs-limit">/ month</span></h5>
                          </div>
                        </div>
...
export default PaymentGrowSuccess;
