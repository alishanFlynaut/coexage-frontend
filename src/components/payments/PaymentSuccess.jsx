...
const PaymentSuccess = () => {
  return (
    ...
    {/* <!-- partial --> */}
    <div className="container-fluid page-body-wrapper pt-70 payment-success-page">
                    ...
                    <div className="ord-summary-body">
                      ...
                      <div className="ord-summary-item">
                        <div className="ord-summary-info">
                          ...
                          <h5 className="title-info">Blog / Article</h5>
                        </div>
                      </div>
                      ...
                      <div className="ord-summary-item">
                        <div className="ord-summary-info pri-info">
                          ...
                          <h5 className="title-info">$74.40 <span className="subs-limit">/ month</span></h5>
                        </div>
                      </div>

                      <div className="ord-summary-item">
                        <div className="ord-summary-info">
                          <span className="label-info">Delivery</span>
                          <h5 className="title-info">7 -10 Business Days</h5>
                        </div>
                      </div>
                      ...
                      <div className="ord-summary-item">
                        <div className="ord-summary-info">
                          ...
                          <h5 className="title-info">100</h5>
                        </div>
                      </div>
                ...
                <div className="pay-details-wrap">
                  <div className="pay-details-card">
                    ...
                    <div className="pay-card-body">
                      ...
                      <p>Start adding project guidelines for your blog</p>

                      <h5>Transcation ID: 8976098754</h5>


                        <div className="text-center">
                          <a href="#" className="btn btn-primary mt-5">Add Project Guidelines</a>
                        </div>
                    </div>
                  </div>
                </div>
