                      ...
                      <div className="ord-summary-body">
                        ...
                        <div className="ord-summary-item">
                          <div className="ord-summary-info">
                            ...
                            <h5 className="title-info">Build</h5>
                          </div>
                        </div>
                        ...
                        <div className="ord-summary-item">
                          <div className="ord-summary-info pri-info">
                            ...
                            <h5 className="title-info">$797.00 <span className="subs-limit">/ month</span></h5>
                          </div>
                        </div>
                        ...
                        <div className="ord-summary-item">
                          <div className="ord-summary-info">
                            ...
                            <h5 className="title-info">3500 words per month</h5>
                          </div>
                        </div>
...
export default PaymentBuildCardDetails;
