...
const PaymentGrowCardDetails = () => {
  return (
    <div className="container-scroller">
      ...
      {/* <!-- partial --> */}
      <div className="container-fluid page-body-wrapper pt-70 payment-grow-card-details payment-success-page">
                      ...
                      <div className="ord-summary-body">
                        <div className="ord-summary-icon-wrap">
                          <div className="ord-summary-icon">
                            <img src="images/rocket-white-icon.png" alt="" />
                          </div>
                        </div>
                        ...
                        <div className="ord-summary-item">
                          <div className="ord-summary-info">
                            ...
                            <h5 className="title-info">Grow</h5>
                          </div>
                        </div>
                        ...
                        <div className="ord-summary-item">
                          <div className="ord-summary-info pri-info">
                            ...
                            <h5 className="title-info">$1497.00 <span className="subs-limit">/ month</span></h5>
                          </div>
                        </div>
                        ...
                        <div className="ord-summary-item">
                          <div className="ord-summary-info">
                            ...
                            <h5 className="title-info">5500 words per month</h5>
                          </div>
                        </div>
...
export default PaymentGrowCardDetails;
