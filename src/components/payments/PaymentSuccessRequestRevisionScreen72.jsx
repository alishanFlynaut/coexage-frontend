...
const PaymentSuccessRequestRevisionScreen72 = () => {
  return (
                      ...
                      <div className="pay-card-body">
                        ...
                        <h5>Transcation ID: 8976098754</h5>
                          ...
                          <div className="text-center">
                            <a href="#" className="btn btn-primary mt-5">Go To Revision Requests</a>
                          </div>
                      </div>
                    </div>
                  </div>
...
export default PaymentSuccessRequestRevisionScreen72;
