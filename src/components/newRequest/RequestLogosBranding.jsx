...
const RequestLogosBranding = () => {
  return (
    <div className="container-scroller">
      ...
      {/* <!-- partial --> */}
      <div className="container-fluid page-body-wrapper pt-70 request-logos-branding-page requests-page-wrap">
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="left-img">
                    ...
                    <img src="images/logos-branding-img.png" />
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="right-content">
                    ...
                    <div className="text-left mt-5">
                      ...
                      <a href="#" className="btn btn-primary mb-3 me-3">Create New Logos & Branding</a>
...
export default RequestLogosBranding;
