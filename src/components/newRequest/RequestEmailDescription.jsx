...
const RequestEmailDescription = () => {
  return (
    <div className="container-scroller">
      ...
      {/* <!-- partial --> */}
      <div className="container-fluid page-body-wrapper pt-70 request-email-description-page requests-page-wrap">
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="left-img">
                    ...
                    <img src="images/email-description-img.png" />
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="right-content">
                    <h2>Email Description</h2>
                    <p>Email Description is an informational piece of content which provides commentary on a given issue. Often written in a more informal tone, blog posts are a great complement to the content on your main site.</p>

                    <p>Email Description posts can be used to promote greater engagement, understanding, or discussion. A blog post is an informational piece of content which provides commentary on a given issue</p>

                    <div className="text-left mt-5">
                      
                      <a href="#" className="btn btn-primary mb-3 me-3">Create New Email Description</a>
...
export default RequestEmailDescription;
