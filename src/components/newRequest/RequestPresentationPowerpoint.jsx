...
const RequestPresentationPowerpoint = () => {
  return (
    ...
    {/* <!-- partial --> */}
    <div className="container-fluid page-body-wrapper pt-70 request-presentation-powerpoint-page requests-page-wrap">
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="left-img">
                  ...
                  <img src="images/presentation-powerpoint-img.png" />
                </div>
              </div>
              <div className="col-md-6">
                <div className="right-content">
                  <h2>Presentation & Powerpoint</h2>
                  ...
                  <div className="text-left mt-5">
                    ...
                    <a href="#" className="btn btn-primary mb-3 me-3">Create New Presentation & Powerpoint</a>
...
export default RequestPresentationPowerpoint;
