...
const RequestWebsite = () => {
  return (
    ...
    {/* <!-- partial --> */}
    <div className="container-fluid page-body-wrapper pt-70 request-website-page requests-page-wrap">
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="left-img">
                  ...
                  <img src="images/press-website-img.png" />
                </div>
              </div>
              <div className="col-md-6">
                <div className="right-content">
                  <h2>Website</h2>
                  <p>Website is an informational piece of content which provides commentary on a given issue. Often written in a more informal tone, blog posts are a great complement to the content on your main site.</p>
                  ...
                  <div className="text-left mt-5">
                    ...
                    <a href="#" className="btn btn-primary mb-3 me-3">Create New Website Content</a>
