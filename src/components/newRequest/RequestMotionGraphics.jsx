...
const RequestMotionGraphics = () => {
  return (
        ...
        <div className="navbar-menu-wrapper d-flex align-items-stretch">
          ...
          <ul className="navbar-nav navbar-nav-right">
            ...
            <li className="nav-item nav-logout d-none d-lg-block">
              <a className="nav-link" href="#">
                <img src="assets/images/ant-design_search-outlined.png" alt="image" />                
              </a>
            </li>
    ...
    {/* <!-- partial --> */}
    <div className="container-fluid page-body-wrapper pt-70 request-motion-graphics-page requests-page-wrap">
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="left-img">
                  ...
                  <img src="images/motion-graphics-img.png" />
                </div>
              </div>
              <div className="col-md-6">
                <div className="right-content">
                  ...
                  <div className="text-left mt-5">
                    ...
                    <a href="#" className="btn btn-primary mb-3 me-3">Create New Motion Graphics</a>
...
export default RequestMotionGraphics;
