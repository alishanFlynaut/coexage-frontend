...
const RequestSocialMediaPosts = () => {
  return (
    ...
    {/* <!-- partial --> */}
    <div className="container-fluid page-body-wrapper pt-70 request-social-media-posts-page requests-page-wrap">
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="left-img">
                  ...
                  <img src="images/press-social-media-posts-img.png" />
                </div>
              </div>
              <div className="col-md-6">
                <div className="right-content">
                  ...
                  <div className="text-left mt-5">
                    ...
                    <a href="#" className="btn btn-primary mb-3 me-3">Create New Social Media Post</a>
...
export default RequestSocialMediaPosts;
