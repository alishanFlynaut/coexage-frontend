...
const RequestProductsDescription = () => {
  return (
    ...
    {/* <!-- partial --> */}
    <div className="container-fluid page-body-wrapper pt-70 request-product-description-page requests-page-wrap">
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="left-img">
                  ...
                  <img src="images/product-des-img.png" />
                </div>
              </div>
              <div className="col-md-6">
                <div className="right-content">
                  <h2>Product Description</h2>
                  <p>Product Description is an informational piece of content which provides commentary on a given issue. Often written in a more informal tone, blog posts are a great complement to the content on your main site.</p>

                  <p>Product Description posts can be used to promote greater engagement, understanding, or discussion. A blog post is an informational piece of content which provides commentary on a given issue</p>

                  <div className="text-left mt-5">
                    <a href="#" className="btn btn-primary mb-3 me-3">Create New Whitepaper Ebook</a>
...
export default RequestProductsDescription;
