...
const RequestPrintMerchandise = () => {
  return (
    <div className="container-scroller">
      {/* <!-- partial:partials/_navbar.html --> */}
      <div classNameName="header-nav-wrap fixed-top d-flex flex-row">
      ...
      {/* <!-- partial --> */}
      <div className="container-fluid page-body-wrapper pt-70 request-print-merchandise-page requests-page-wrap">
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="left-img">
                    ...
                    <img src="assets/images/print-merchandise-img.png" />
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="right-content">
                    <h2>Print Merchandise</h2>
                    <p>Lorem ipsum dolor sit amet consectetur. Cum duis eget in tristique sit lacus non. Semper a eget posuere est. Porttitor massa tellus velit a et donec consectetur condimentum in. Sed eu urna etiam maecenas tellus venenatis gravida. Eget adipiscing tortor nibh volutpat mi sit.</p>

                    <p>Quisque blandit arcu pharetra justo ornare suspendisse. Vel feugiat bibendum nascetur nunc tempor posuere sit. Eget cras morbi cras est aliquam purus eu.</p>

                    <div className="text-left mt-5">
                      
                      <a href="#" className="btn btn-primary mb-3 me-3">Create New Print Merchandise</a>
...
export default RequestPrintMerchandise;
