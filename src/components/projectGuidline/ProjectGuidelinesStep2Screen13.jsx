...
const ProjectGuidelinesStep2Screen13 = () => {
  return (
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-6">
                          <div className="form-group">
                            ...
                            <div className="single-input">
                              <img src="images/H1.png" alt="image" />
                          ...
                          <div className="form-group">
                            ...
                            <div className="down-arrow-input d-flex">
                              <span className="d-flex up-down-arrow">
                                <img src="images/arrow-up.png" alt="images" />
                                <img src="images/arrow-down.png" alt="images" />
                              </span>
                              <div className="single-input1 d-flex">
                                <div className="title-dropdown">
                                  <img src="images/H2.png" alt="" className="title-icon" />
                                  <div className="m-border"></div>
                                  <img src="images/bxs_down-arrow.png" alt="images" />
                                </div>
...
export default ProjectGuidelinesStep2Screen13;
