...
const ProjectGuidelinesFormFilled = () => {
  return (
          ...
          <div className="content-wrapper text-center">
            <div className="container">
              <div className="get-started-frm-wrap">
                ...
                <div className="content-bg-white form-filled text-left">
                  <div className="row">

                    <div className="col-md-12">
                      <h2>Review Project Guidelines</h2>
                    </div>
                    ...
                    <div className="col-md-6">
                      <div className="form-group">
                        ...
                        <p>Topic Name will come here</p>
                      </div>
                    </div>
                    <div className="col-md-12">
                      <div className="form-group">
                        <label className="col-form-label">Outline</label>
                        <p>H1: Lorem ipsum dolor sit amet consectetur. Non sit enim commodo massa vitae. Lectus eget vitae conor.</p>
                      </div>
                    </div>
                    <div className="col-md-12">
                      <div className="form-group">
                        <label className="col-form-label">Campaign</label>
                        <p>Lorem ipsum dolor sit amet consectetur. Non sit enim commodo massa vitae. Lectus eget vitae conor.</p>
                      </div>
                    </div>
                    ...
                    <div className="col-md-12">
                      <div className="form-group">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur. Amet risus imperdiet vel sed gravida tortor. Nunc egestas fermentum tellus venenatis vestibulum et eget euismod. In congue tristique nulla arcu vitae nisl rhoncus et eget. Ornare magna eget vitae eget urna donec arcu. Aenean libero fringilla integer dui. Aliquam mauris ornare eros lorem adipiscing a. Aliquam donec bibendum lorem turpis.</p>
                      </div>
                    </div>
                    ...
                    <div className="col-md-6">
                      <div className="form-group">
                        <label className="col-form-label">Style & Tone</label>
                        <p>Topic Name will come here</p>
                      </div>
                    </div>
                    ...
                    <div className="col-md-12">
                      <div className="form-group">
                        <label className="col-form-label">Research Links</label>
                    ...
                    <div className="text-center mt-5">
                      <a href="#" className="btn btn-secondary me-3">Edit</a>
                      <a href="#" className="btn btn-primary">Review & Submit</a>
                    </div>
...
export default ProjectGuidelinesFormFilled;
