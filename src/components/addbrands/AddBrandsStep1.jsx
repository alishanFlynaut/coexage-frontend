                          ...
                          <div className="form-group">
                            ...
                            <div className="single-input">
                              <select id="exampleInputShowing" className="form-select form-select-lg">
                                ...
                                <option value="IT Company / Software Company">IT Company / Software Company</option>
                                <option value="Banking Finance & Insurance">Banking Finance & Insurance</option>
                                <option value="Corporate">Corporate</option>
                                <option value="Entertainment / Art / Design">Entertainment / Art / Design</option>
                          ...
                          <div className="form-group">
                            ...
                            <div className="row">
                              <div className="col-md-6">
                                <div className="single-input">
                                 <div className="form-check radio-input">
                                    <input className="form-check-input" type="radio" name="flexRadioDefault30" id="flexRadioDefault2" checked/>
                          ...
                          <div className="form-group">
                            <div className="row">
                              <div className="col-md-6">
                                <div className="single-input">
                                 <div className="form-check radio-input">
                                    <input className="form-check-input" type="radio" name="flexRadioDefault300" id="flexRadioDefault40" checked/>
                                    <label className="form-check-label" for="flexRadioDefault40">
                              ...
                              <div className="col-md-6">
                                <div className="single-input">
                                 <div className="form-check radio-input">
                                    ...
                                    <label className="form-check-label" for="flexRadioDefault401">
                                      Narrative Structure
                                    </label>
